...
def _sanitize_input(text: str) -> str:
    ...
    logger.info("Best-of-N: Sanitizing input to remove code blocks")
...
def best_of_n_sampling(
    ...
    # Sanitize input to prevent code block errors
    ...
    try:
        ...
        for i in range(n):
            try:
                ...
                # Add delay between completions to avoid rate limits
                if i < n - 1:
                    time.sleep(4.5)
