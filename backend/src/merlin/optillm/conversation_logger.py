...
def sanitize_for_logging(data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Sanitize sensitive data from request/response before logging.

    Removes API keys, authorization headers, and other sensitive fields
...
class ConversationLogger:
    ...
    def start_conversation(
        ...
        entry = ConversationEntry(
            ...
            approach=approach,
            model=model,
            client_request=sanitize_for_logging(client_request),
        )
    ...
    def log_provider_call(
        ...
        with self._lock:
            ...
            call_data = {
                ...
                "timestamp": datetime.now(timezone.utc).isoformat(),
                "request": sanitize_for_logging(provider_request),
                "response": sanitize_for_logging(provider_response),
            }
    ...
    def log_final_response(
        ...
        with self._lock:
            ...
            entry.final_response = sanitize_for_logging(final_response)
